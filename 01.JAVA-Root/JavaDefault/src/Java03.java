...
public class Java03 {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("myFace모두대문자:"+
        myFace.toUpperCase());
        // toLowerCase() - 모두 소문자 변환
        System.out.println("myFace모두소문자:"+
        myFace.toLowerCase());
        ...
        System.out.println("Handsome문자열시작위치:"+
        ...
        System.out.println("Hand만 잘라서 가져와봐! "+
        ...
        String familyName = "공";
        System.out.println(
            familyName.concat("문자열연결:"+name)); // "공유"
        System.out.println(
            familyName.concat("공유의 동생이름은?"+name2)); // "공룡"
        ...
        System.out.println("10.1과 10.11 중 큰것은? "+
        Math.max(10.1,10.11));
        // 2.Math.min( x,y ) -  x 와 y 중 최소값
        System.out.println("10001과 10002 중 작은것은? "+
        Math.min(10001, 10002));
        // 3. Math.sqrt( x ) - 제곱근값
        System.out.println("2의 제곱근값은? "+Math.sqrt(2));
        // 4. Math.abs(x) - 절대값
        System.out.println(
            "나는 1000원이 있는데 10000원을 썼다. 순수차액은 얼마? "+Math.abs(1000-10000)+"원");
